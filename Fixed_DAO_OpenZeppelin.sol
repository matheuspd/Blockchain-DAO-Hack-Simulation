...
contract Simple_Fixed_DAO is ReentrancyGuard {
    struct Proposal {
    ...
    ***** Fixed for reentrancy attacks with OpenZepellin *****
    ***** (Updating the balance before still is a good practice) *****
    */
    function withdraw() public nonReentrant {
        uint256 balance = shares[msg.sender];
        require(balance > 0, "No balance to withdraw");

        // Send Ether to user before updating balance
